...
```bash
* * * * * /bin/bash -c "source /home/dthisc/venvs/dthisc/bin/activate && /home/dthisc/venvs/dthisc/bin/python3 /home/dthisc/dthis-c/scripts/scd30.py" >> /home/dthisc/dthis-c/scripts/scd30.py.log 2>&1
```
