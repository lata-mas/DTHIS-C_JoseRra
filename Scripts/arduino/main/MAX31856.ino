 ...
 * 
 * Descripción:
 * Esta función lee las mediciones de temperatura de dos termopares tipo T conectados
 * a un shield PWFusion MAX31856. Devuelve un puntero a un array de dos posiciones 
 ...
 * - Devuelve un puntero a un array que contiene las dos temperaturas medidas.
 * 
 * Retorno:
 * - Puntero a un array de dos floats que contienen las temperaturas medidas.
 * 
 * Notas:
