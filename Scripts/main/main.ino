...
#define WIFI_AP "Totalplay-05AF"          // Nombre del punto de acceso WiFi
#define WIFI_PASSWORD "05AF13993XNwmHyA"  // Contraseña de la red WiFi
#define TOKEN "1OEilpG3goyYcWLZvuz0"      // Token de autenticación para ThingsBoard
#define THINGSBOARD_SERVER "tb.ier.unam.mx" // Dirección del servidor de ThingsBoard
